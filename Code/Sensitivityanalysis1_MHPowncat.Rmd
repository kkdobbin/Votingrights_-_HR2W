---
title: "Sensitivityanalysis1_MHPowncat"
...
Data <- Data %>% 
  mutate(enfranchisement_final = case_when(Final_inst_update == "Mobile Home Park" ~ "Mobile Home Park", 
                                           .default = enfranchisement_final)) %>%
  mutate(enfranchisement_final = as.factor(enfranchisement_final))

library(plyr)
Data$enfranchisement_final <- revalue(Data$enfranchisement_final, c("None" = "IOU"))
...
Compositestable <- capture.output(stargazer(compositemodellist,
                                 ...
                                 omit.stat = c("ll", "aic"),
                                 covariate.labels = c("Lim enfran.", "Mobile Home Park", "IOU", 
